...
class ShapDynamicParameterMovieCreator(DynamicParameterMovieCreator):
    ...
    def create_dynamic_parameter_movie_shap(self, model_name: str = 'circular_fingerprint'):
        ...
        for iteration in range(self.max_iters):
            ...
            # Collision stats for current FP config (D metric helpers) - simplified
            # These advanced metrics are optional and not critical for evaluation plots
            try:
                ...
                # Fallback if advanced metrics not available
                collision_stats = {
            ...
            # Choose target if not set - prefer Series C compound
            ...
            if not feature_weights_target:
                ...
                if len(active_indices) > 0:
                    ...
                    feature_weights_target = {}
            # Apply collision adjustment (D) - optional
            try:
                ...
                # If collision adjustment is not available, continue with original weights
                pass
